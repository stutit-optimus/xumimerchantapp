...
public class SplashPage extends AbstractPage {
    private static final Logger LOGGER = Logger.getLogger(SplashPage.class);
    ...
    public void emailVerificationCode() {
        ...
        enterInput(enterSecondCodeId, "2");
...
//            }
    ...
    public void phoneNoTextedCode() {
        wait.until(ExpectedConditions.presenceOfElementLocated(codeTextedToPhoneTextId));
        enterInput(enterFirstPhoneCodeTxtId, "1");
        enterInput(entersecondPhoneCodeTxtId, "2");
        enterInput(enterThirdPhoneCodeTxtId, "3");
        enterInput(enterForthPhoneCodeTxtId, "4");
        enterInput(enterFifthPhoneCodeTxtId, "5");
        enterInput(entersixthPhoneCodeTxtId, "6");
    }
    ...
    public void businessDetailsScreen(String businessName) {
        wait.until(ExpectedConditions.presenceOfElementLocated(businessNameTextId));
